...
export default async function ProjectRisksPage({ searchParams }: { searchParams: { entityId?: string; projectId?: string } }) {
      ...
      {data && (
        <>
          ...
          <section>
            ...
            <CreateRiskForm entityId={entityId} projectOptions={data.projectOptions} initialProjectId={projectId} />
            <ProjectRisksTable
              risks={data.risks}
