...
const routes = [
  '/boq', '/facility-management', '/handover', '/inventory', '/procurement',
  '/project-issues', '/project-resources', '/project-risks', '/project-tasks',
  '/work-packages', '/pmo'
];

test.describe('Batch 3 Operations Modules', () => {
