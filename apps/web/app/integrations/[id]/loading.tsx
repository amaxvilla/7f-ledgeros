...
/**
 * Frontend Completion, FE-7.2. Next.js App Router special file, scoped
 * to `/integrations/[id]` — same per-route Suspense boundary every
 * module page since Checkpoint C has gotten.
 */
export default function IntegrationProviderLoading() {
  return (
