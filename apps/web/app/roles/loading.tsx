 ...
 * `/roles` — same per-route Suspense boundary shape every module page
 * in this app already establishes. Four KPI-card placeholders, matching
 * this route's own four `KpiCard`s.
 */
