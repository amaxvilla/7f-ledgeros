 ...
 * before-coding finding. `statement/page.tsx` has exactly 2 `KpiCard`s
 * (confirmed by direct count), so this mirrors `/payments/loading.tsx`'s
 * own shape with 2 tiles instead of 4.
 */
