...
/**
 * Frontend Completion, FE-9.4. Next.js App Router special file, scoped
 * to `/reports` — same per-route Suspense boundary shape
 * `/financial-statements/loading.tsx` already establishes.
 */
